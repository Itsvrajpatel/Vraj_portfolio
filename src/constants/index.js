...
const experiences = [
  {
    title: "Full Stack Developer",
    company_name: "DigiBenders Inc.",
    icon: DB,
    iconBg: "#383E56",
    date: "Jan 2024 - Present",
    points: [
      "Working on production web applications using React, Next.js, Node.js, and Postgres SQL.",
      "Developing reusable frontend components and backend REST APIs.",
      "Implement Dynamic Notifications System with Mark as Read Functionality.",
      "Collaborating with designers and stakeholders to translate business requirements into technical solutions.",
      "Improving application performance and user experience through code optimization.",
      "Participating in code reviews and maintaining version control using Git.",
    ],
  },
  {
...
const projects = [
  ...
  },
  {
    ...
    image: sambhu,
    source_code_link: "https://github.com/Itsvrajpatel/Shambhu-e-solutions",
    live_link: "https://itsvrajpatel.github.io/Shambhu-e-solutions/",
  },
  {
    name: "Gamezy",
    description:
    ...
    live_link: "https://itsvrajpatel.github.io/Gamezy/",
  },
];
